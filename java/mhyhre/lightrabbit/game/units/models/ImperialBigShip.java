...
public class ImperialBigShip  extends UnitModel {

    private float targetRotation = -30;

    public ImperialBigShip(int id) {
        super(id, UnitType.IMPERIAL_BIG_SHIP, 250, 80, 1.0f, 0.8f, ControllType.LEFT_RIGHT);
    ...
    public void update(WaterPolygon water) {
        ...
        if (isDied == true) {
            ...
            float waveYPositionUnderPlayer = water.getObjectYPosition(getX());

            if(getY() < waveYPositionUnderPlayer - 4 && canJump == false) {
