...
public class Bullet20Unit extends Projectile {

    public static final float sGravity = -0.01f;

    private Vector2 mAcceleration;
    protected int mBoom;
    protected int mBoomPower;
    
    protected float bulletRaduis = 4;

    public Bullet20Unit(float pX, float pY, UnitModel parent) {
        super(parent, pX, pY);
        
        setType(ProjectileType.Bullet20);
