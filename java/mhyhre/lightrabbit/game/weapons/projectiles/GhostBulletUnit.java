...
public class GhostBulletUnit extends Projectile {

    public static final float sSinkSpeed = -3.0f;
    public static final float sGravity = -0.20f;
    ...
    public GhostBulletUnit(float pX, float pY, UnitModel parent) {
        super(parent, pX, pY);
        
        setType(ProjectileType.GhostBullet);
