...
public class ButtonUIShaderEffect extends ShaderProgram {
    ...
    public ButtonUIShaderEffect(float startTimeValue, float buttonsWidth, float buttonsHeight) {
        super(loadFromFile("shaders/base_vertex_shader.vs"), loadFromFile("shaders/button_ui_shader.fs"));
    ...
    public void bind(final GLState pGLState, final VertexBufferObjectAttributes pVertexBufferObjectAttributes) {
        ...
        timeValue += 0.02f;
        if(timeValue > 31.428f) {
            timeValue = 0.0f;
        }
        
        GLES20.glUniform1f(timeLocation, timeValue);    
        GLES20.glUniform2f(resolutionLocation, MainActivity.getWidth(), MainActivity.getHeight());//width, height);  
    }
}
