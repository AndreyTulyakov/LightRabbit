...
public class MenuShaderEffect extends ShaderProgram {
    ...
    public MenuShaderEffect() {
        super(loadFromFile("shaders/base_vertex_shader.vs"), loadFromFile("shaders/menu_shader.fs"));
