...
public class SceneExit extends MhyhreScene {
	...
	public SceneExit() {
		...
		// Creating sprite
		mExitButtonSprite = new Sprite(0, 94,
		...
		mBackButtonSprite = new Sprite(0, 154,
				MainActivity.Res.getTextureRegion("Button1"),
				MainActivity.Me.getVertexBufferObjectManager()) {
			@Override
			public boolean onAreaTouched(TouchEvent pSceneTouchEvent,
		...
		mCaptionItem2.setPosition(
				mBackButtonSprite.getX() + mBackButtonSprite.getWidth() /2 - mCaptionItem2.getWidth()/2,
				mBackButtonSprite.getY() + mBackButtonSprite.getHeight()/2 - mCaptionItem2.getHeight()/2);
		
		mCaptionItem3.setPosition(
				mExitButtonSprite.getX() + mExitButtonSprite.getWidth() /2 - mCaptionItem3.getWidth()/2,
				mExitButtonSprite.getY() + mExitButtonSprite.getHeight()/2 - mCaptionItem3.getHeight()/2);
