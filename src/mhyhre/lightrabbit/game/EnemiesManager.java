...
public class EnemiesManager extends SpriteBatch {
    ...
    public void addNewEnemy(Event event) {
        ...
        if (mEnemies.size() < ENEMIES_MAX_COUND && waitState == false) {
             ...
             * 
             * case NEW_PIRATE_BOAT: PirateBoatUnit pirateBoat = new PirateBoatUnit(); pirateBoat.setPosition(xpos,0); mEnemies.add(pirateBoat); break;
             * 
             ...
             * 
             * case NEW_SHARK: SharkUnit shark = new SharkUnit(); shark.setPosition(xpos,0); mEnemies.add(shark); break;
             * 
             * case WAIT: waitState = true; break;
             * 
             * default: break; }
             */
        }
